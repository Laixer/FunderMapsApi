...
const info = new Map<string, AddressInfo>([
  ["gfm-own", { id: "gfm-own", buildingId: "NL.IMBAG.PAND.1", label: "Molenwal 15, 3421 CK Oudewater" }],
  ["gfm-17", { id: "gfm-17", buildingId: "NL.IMBAG.PAND.2", label: "Molenwal 17, 3421 CK Oudewater" }],
  ["gfm-19", { id: "gfm-19", buildingId: "NL.IMBAG.PAND.3", label: "Molenwal 19, 3421 CK Oudewater" }],
  ["gfm-59a", { id: "gfm-59a", buildingId: "NL.IMBAG.PAND.4", label: "Molenwal 59A, 3421 CK Oudewater" }],
]);
